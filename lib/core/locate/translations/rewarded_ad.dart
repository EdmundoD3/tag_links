...
final Map<String, Map<AppLang, String>> rewardedTranslations = {
  ...
  //Modal Management Ads
  'modalDisableAdsTitle': {
    AppLang.es: '¿Te estorba la publicidad?',
    AppLang.en: 'Are ads getting in your way?',
  },
  'modalDisableAdsSubtitle': {
    AppLang.es: 'Puedes quitar los anuncios viendo un video o apoyar el proyecto',
    AppLang.en: 'You can remove ads by watching a short video or supporting the project.',
  },
  'removeAds24h': {
  ...
  'buyMeCoffeeDescription':{
    AppLang.es: 'Si te gusta la app, invítame un café para apoyar el proyecto',
    AppLang.en: 'If you like the app, buy me a coffee to support the project.',
  }
};
